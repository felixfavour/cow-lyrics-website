...
useSeoMeta({
  ...
  description:
    "Discover and share Christian worship song lyrics with the community. Find recently added songs and popular artists.",
...
useSchema([
  {
    ...
    description:
      "Discover and share Christian worship song lyrics with the community",
    publisher: {
      "@type": "Organization",
